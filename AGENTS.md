...
- Minion slots are permanently unlocked through the typed `unlockMinionSlot` Soul Catcher effects;
  Soul Catcher reset preserves each permanent unlock, the roster, and per-slot progression.
  Active minions and engaged enemies simulate across unlocked areas even when their views
