...
export const HERO_COMBAT_EXIT_DELAY_SECONDS = balance.hero.combatExitDelaySeconds;
export const HERO_OUT_OF_COMBAT_REGEN_MULTIPLIER = balance.hero.outOfCombatRegenMultiplier;
