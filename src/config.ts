...
export const HERO_ATTACK_RANGE = balance.hero.bareHandsRange;
export const HERO_ATTACK_COOLDOWN = balance.hero.attackCooldownSeconds;
export const ENEMY_AGGRO_RADIUS = balance.enemy.aggroRadius;
export const ENEMY_LEASH_RADIUS = balance.enemy.leashRadius;
export const ENEMY_ATTACK_RANGE = HERO_ATTACK_RANGE * balance.enemy.attackRangeVsBareHandsMultiplier;
