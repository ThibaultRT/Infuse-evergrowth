import { AREAS, SPAWNS } from '../config';
...
import { freshMinionStats, emptySoulContributions, validMinionColor, MINION_SLOTS, minionPitPosition } from '../domain/minions';
...
import { freshStat, freshEvasion, freshStats, emptyInventory, emptySpawnState } from './SaveDefaults';
...
export function decodeSave(raw: string, now: Date): SaveData | null {
  try {
