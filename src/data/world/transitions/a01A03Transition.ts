...
export const A01_A03_TRANSITION = {
  ...
  props: [
    ...createWallRun({ prefix: 'A03_CurtainWall_West', prop: 'fortress.wall', brokenProp: 'fortress.wallBroken', brokenEvery: 4, from: [0, -35.5], to: [0, 35.5], spacing: 6.4, elevation: 1.1, scale: 1.08, rotationOffset: -Math.PI, omitIndices: [11, 12], gaps: [{ center: [0, 3.6], radius: 4.2 }] }),
    ...
    { name: 'A03_Corner_SW', prop: 'fortress.corner', position: [6, 1.1, 35.5], rotation: 5 * Math.PI / 3, scale: 1.1 },
  ],
  scatters: [],
  collision: [
