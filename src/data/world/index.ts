...
import { AREA_A04_LAYOUT } from './areas/areaA04Layout';
import { A01_A04_TRANSITION, A03_A04_TRANSITION } from './transitions/area4RiftTransition';
...
export const AREA_WORLD_LAYOUTS = [AREA_A01_LAYOUT, AREA_A02_LAYOUT, AREA_A03_LAYOUT, AREA_A04_LAYOUT] as const satisfies readonly AreaWorldLayout[];
export const TRANSITION_WORLD_LAYOUTS = [A01_A02_TRANSITION, A01_A03_TRANSITION, A02_A03_TRANSITION, A01_A04_TRANSITION, A03_A04_TRANSITION] as const satisfies readonly TransitionWorldLayout[];
