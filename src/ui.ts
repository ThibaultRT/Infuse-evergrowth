...
export function renderStats(stats: PlayerStats): void {
  ...
  ui.statsContent.innerHTML = [renderBreakdown(maxHpLabel, stats.maxHp), renderBreakdown(bluntLabel, stats.attack.blunt), renderBreakdown('Slash attack', stats.attack.slash), renderBreakdown('Piercing attack', stats.attack.piercing), renderBreakdown('Blunt defence', stats.defense.blunt), renderBreakdown('Slash defence', stats.defense.slash), renderBreakdown('Piercing defence', stats.defense.piercing), renderBreakdown('Blunt resistance', percentStat(stats.damageResistance.blunt), '%'), renderBreakdown('Slash resistance', percentStat(stats.damageResistance.slash), '%'), renderBreakdown('Piercing resistance', percentStat(stats.damageResistance.piercing), '%'), renderBreakdown(regenLabel, stats.regen, ' HP/s'), scaled('Speed', stats.speed, HERO_SPEED, ' m/s'), scaled('Critical hit chance', stats.criticalChance, HERO_CRITICAL_CHANCE_PERCENT, '%'), scaled('Critical damage', stats.criticalDamage, HERO_CRITICAL_DAMAGE_PERCENT, '%'), scaled('Block chance', stats.blockChance, HERO_BLOCK_CHANCE_PERCENT, '%'), evasion, `<section class="stat-breakdown"><div class="stat-row"><span>Soul Drops</span></div>${souls}</section>`].join('');
}
