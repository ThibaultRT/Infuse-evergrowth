...
export class GameCommands {
  constructor(private readonly state: SaveData, private readonly runtime: GameplayRuntime, private readonly events: GameEvents, private readonly persist: () => void, private readonly soulCatcher: SoulCatcherSystem) {}
